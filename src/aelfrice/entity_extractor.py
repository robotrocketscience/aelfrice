...
# (`MemoryStore`, `GraphEigenbasisCache`) with at least two parts.
# The two-part requirement keeps single English words (`apply`,
# `session`) out — those are noun_phrase candidates.
