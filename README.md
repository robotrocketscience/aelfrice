...
Latest stable: **v4.3.0** (2026-08-13). Per-entry detail in [CHANGELOG § 4.3.0](CHANGELOG/v4.md). Per-version history: [docs/concepts/ROADMAP.md](docs/concepts/ROADMAP.md). Known limits: [docs/user/LIMITATIONS.md](docs/user/LIMITATIONS.md).
