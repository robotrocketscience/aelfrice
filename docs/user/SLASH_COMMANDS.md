...
The behavior matches the CLI exactly. For the command reference, see [COMMANDS](COMMANDS.md). The v1.1.0 user-facing rename of `edges` to `threads` doesn't surface here, and the program name remains `aelf`.
