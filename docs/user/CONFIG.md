...
# n_returned intact), `aelf rebuild` and the SessionStart
# <aelfrice-baseline> block all keep working; a suppressed fire
# records no injection_events / belief_touches / ring entry and no
# source='hook' feedback_history row, since the model never saw
# those beliefs. The AELFRICE_MEMORY_BLOCK env
