...
- [`DOCS-AUDIT-2026-07-04.md`](DOCS-AUDIT-2026-07-04.md) — doc-file-surface audit vs HEAD `33b7ddd5` (v3.8.0 + post-release main), v4.0.0 release gate; #1075. 0 CRITICAL/HIGH, 9 MEDIUM, 8 LOW, 1 code-side. In-code documentation layer (docstrings/help/MCP descriptions across 552 .py) deferred to a follow-up.
