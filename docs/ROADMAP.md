...
| **v3.0.0** | shipped | wonder lifecycle complete (#542 umbrella + #547/#550/#552), wonder/reason agentmemory parity (#645), HRR persistence default-ON + split-format migration (#553), type-aware compression (#434), federation read-only mechanics (#650 umbrella: scope visibility #688, promote/demote `--to-scope` #689, peer-aware reason walk #690, transport #655), eval-judge κ calibration runner (#687). v3.0 design decisions ratified: NL-relatedness philosophy (#605, Option 1 deterministic narrow surface), sentiment-feedback hook (#606, UserPromptSubmit lane, default-off), multimodel scope (#607, deferred — no maintainer validation path), federation write model (#661, read-only). Bench-only items #152, #592, #697 carry `attn:bench-needed` and are deferred-with-rationale per the milestone-tracker DoD. Milestone tracker: [#608](https://github.com/robotrocketscience/aelfrice/issues/608). |
