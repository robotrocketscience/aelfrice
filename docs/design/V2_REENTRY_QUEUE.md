...
- **Iteration spec:** [`docs/design/v2_directive_detection.md`](v2_directive_detection.md). The shipped detector measures **P=0.706 / R=0.937** against lab corpus v0.1 (re-run 2026-08-05, [#1341](https://github.com/robotrocketscience/aelfrice/issues/1341)); the P=0.664 previously quoted here was the pre-Path-A number. Corpus v0.1 alone could not certify a detector — a first-token-only classifier cleared the gate on **196 of 200** salted partitions of it. **Corpus v0.2 landed 2026-08-05** (225 minimal pairs, #1341/#1349) and drops that to **0 of 200**; the union measures the detector at **P=0.665 / R=0.636**. H1 stays deferred, now on a valid number, and recall is the binding constraint rather than precision. See that memo § Gate validity.
