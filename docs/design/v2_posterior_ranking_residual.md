...
- **Public claim alignment:** [`docs/user/LIMITATIONS.md § "The big one"`](../user/LIMITATIONS.md), [`docs/user/CONFIG.md`](../user/CONFIG.md), and [`docs/design/bayesian_ranking.md`](bayesian_ranking.md) all currently caveat "10-round MRR uplift, ECE calibration, BM25F + heat-kernel composition — lands at v2.0.0". This issue is what makes that caveat true.
