...
- [x] `docs/user/CONFIG.md` and `docs/user/COMMANDS.md` document the new flags and `aelf doctor` rows. (PR [#699 — this bundle](https://github.com/robotrocketscience/aelfrice/issues/699))
...
- `docs/concepts/ROADMAP.md` v2.1 row gains an HRR persistence + format-migration line, paired with the existing #474 milestone tracker.
