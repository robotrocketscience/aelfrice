...
- Posterior-weighted L1 ranking (`docs/design/bayesian_ranking.md`,
  `docs/design/v2_posterior_ranking_residual.md`) consumes the posterior in
...
`docs/design/bayesian_ranking.md` so both numbers are produced from one
