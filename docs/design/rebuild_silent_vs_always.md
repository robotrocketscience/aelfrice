...
`docs/design/context_rebuilder.md` gains a "Relevance floor" section
...
- Sibling specs:
  - `docs/design/rebuild_eval_harness.md` (#288 / merged via #294).
  - `docs/design/belief_retention_class.md` (#290 / merged via #296).
